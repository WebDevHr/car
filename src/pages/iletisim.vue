...
import AddressComp from '@/components/ContactComponents/AddressComponent.vue';
  ...
  <div>
    ...
    <section class="myCostumContainer">
      <div class="flex lg:flex-row flex-col">
        <address-comp class="lg:basis-2/5 w-full mb-10 lg:pt-10" />
        <GoogleMap class="lg:basis-3/5 w-full" />
      </div>
    </section>
    <div class="myCostumContainer flex lg:flex-row flex-col mt-10 lg:mt-0">
      <div class="flex lg:basis-2/5 basis-full">
        <div class="md:w-[727px] xs:w-[465px] w-full lg:pt-10 lg:mt-10">
        ...
        <base-form>
          ...
          <div
            ...
            <input type="text" id="name" v-model="formData.name"
              class="p-2 border-none rounded-full focus:border-none no-shadow font-semibold w-full"
              placeholder="Adınız" />
          </div>
          <div
            class="mb-4 border border-orange-500 rounded-full flex flex-row justify-center items-center scrollContactForm">
          ...
          <div
            class="mb-4 border border-orange-500 rounded-xl flex flex-row justify-center items-center scrollContactForm">
            ...
            <textarea type="text" id="message" v-model="formData.message"
              class="p-2 border-none rounded-xl focus:border-none no-shadow font-semibold w-full min-h-[50px]"
